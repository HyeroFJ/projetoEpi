...
class ColaboradorEpi{
  ...
  factory ColaboradorEpi.fromJson(Map<String,dynamic> json){
    ...
    var parsedDE = DateTime.parse(json['dataEntrega']);
    final databre = DateFormat("dd/MM/yyyy").format(parsedDE);

    return ColaboradorEpi(idEnt: json['idEnt'], dataValidade: databrv.toString(), dataEntrega: databre.toString(), idEpi: json['idEpi'], idCol: json['idCol']);
  }
}